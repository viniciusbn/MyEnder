 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT_HOME  280        // (mA) RMS current for sensorless homing. Lower for better StallGuard sensitivity.
    ...
    #define Y_CURRENT_HOME  280        // (mA) RMS current for sensorless homing
