 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN //VBN for system with one extruder, E1 can be used as auto fan mode for hot end
...
#define EXTRUDER_AUTO_FAN_TEMPERATURE 80 //VBN power on the hot end fan when the temperature is above 50º
#define EXTRUDER_AUTO_FAN_SPEED 115   //VBN 255 == full speed , set the speed for hot end fan
